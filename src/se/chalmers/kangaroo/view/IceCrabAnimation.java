...
public class IceCrabAnimation implements Animation{
	private int tick;
	 ...
	 */
	public IceCrabAnimation(){
		tick = 0;
		currentSprite = 0;
		this.sheet = Toolkit.getDefaultToolkit().getImage("resources/gfx/sheets/crab_ice_256x32.png");
		this.width = 64;
		this.height = 32;
	}
	@Override
